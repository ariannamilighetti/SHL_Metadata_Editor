...
class Metadata_Visualiser(tk.Frame):
    def __init__(self):
        ...
        self.create_list("Digitised by", 'digitiser_validation.txt', 2)
        self.create_list("Access Restriction", 'access_validation.txt', 4)
        self.create_list("Restriction Type", 'restriction_validation.txt', 6)
        self.create_list("Copyright Status", 'copyright_validation.txt', 8)
        self.create_collections("Collections", 'collections_validation.txt', 0)
    ...
    def create_list(self, title, file, column):
        self.Lb = tk.Listbox(self.frame, width=30, height=30)
